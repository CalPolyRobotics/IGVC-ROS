...
if("TRUE" STREQUAL "TRUE")
  set(liblms1xx_SOURCE_PREFIX /home/daschulz/IGVC/rosLidarRepo/RCPRG_laser_drivers/liblms1xx)
  set(liblms1xx_DEVEL_PREFIX /home/daschulz/IGVC/rosLidarRepo/RCPRG_laser_drivers/liblms1xx/devel)
  ...
  set(liblms1xx_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/daschulz/IGVC/rosLidarRepo/RCPRG_laser_drivers/liblms1xx/libLMS1xx" STREQUAL "")
  set(liblms1xx_INCLUDE_DIRS "")
  set(_include_dirs "/home/daschulz/IGVC/rosLidarRepo/RCPRG_laser_drivers/liblms1xx/libLMS1xx")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'liblms1xx' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/daschulz/IGVC/rosLidarRepo/RCPRG_laser_drivers/liblms1xx/${idir}'.  Ask the maintainer 'kp <kp@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/daschulz/IGVC/rosLidarRepo/RCPRG_laser_drivers/liblms1xx/devel/lib;/opt/ros/hydro/lib)
