...
initFNR = True          # Initialize FNR to forward
...
x0 = 2.0                # Inner Threshold distance (meters)
x1 = 5.0                # Outer Threshold distance (meters)
...
def findOurDistance(data):
    ...
    for i in range(130, 421):                    # Range of lidar data we want to read (values in front of lidar)
