...
def get_sonar_1_resp(data):
    """
    get_sonar_1_resp

    Publishes the data from a get_sonar_1_resp
    """
    #TODO Implement Sonar 1
    SONAR1.publish(0)

def get_sonar_all_resp(data):
    """
    get_sonar_all_resp

    Publishes the data from a get_sonar_all_resp
    """
    #TODO Implement Sonar ALL
    SONARALL.publish([0, 0, 0, 0, 0, 0])
