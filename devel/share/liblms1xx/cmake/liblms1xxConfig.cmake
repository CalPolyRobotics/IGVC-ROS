...
if("TRUE" STREQUAL "TRUE")
  set(liblms1xx_SOURCE_PREFIX /home/caddy/IGVC-ROS/src/liblms1xx)
  set(liblms1xx_DEVEL_PREFIX /home/caddy/IGVC-ROS/devel)
  ...
  set(liblms1xx_INSTALL_PREFIX /home/caddy/IGVC-ROS/install)
...
if(NOT "/home/caddy/IGVC-ROS/src/liblms1xx/libLMS1xx" STREQUAL "")
  set(liblms1xx_INCLUDE_DIRS "")
  set(_include_dirs "/home/caddy/IGVC-ROS/src/liblms1xx/libLMS1xx")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'liblms1xx' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/caddy/IGVC-ROS/src/liblms1xx/${idir}'.  Ask the maintainer 'kp <kp@todo.todo>' to fix it.")
    endif()
